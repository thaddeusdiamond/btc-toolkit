...
export function GroupedButton(props) {
  ...
  return (
    <button type="button"
            ...
            className={`${currentBg} ${borderRounding} ${marginLeft} relative items-center px-3 py-3 text-sm text-center font-semibold ring-1 ring-inset ring-gray-300 focus:z-10`} >
      {props.label}
    </button>
  );
}
